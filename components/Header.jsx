...
function Header({ placeholder }) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md  px-3 md:p-3 md:px-10">
      <div 
      onClick={() => router.push('/')}
      ...
      <div className="flex col-span-2 md:col-span-1 m-2 justify-center items-center md:border-2 rounded-full py-1 md:shadow-sm text-gray-600 text-sm placeholder-gray-400">
        <input
          value={searchInput}
        ...
        <div className="flex md:hidden md:auto  w-auto md:col-span-1 md:space-x-4 items-center justify-end text-gray-500 ">
