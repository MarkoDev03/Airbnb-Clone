...
function Header({ placeholder }) {
  ...
  return (
    <header className="sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md  px-1 md:p-3 md:px-10">
      <div 
      onClick={() => router.push('/')}
      ...
      <div className="flex col-span-2 md:col-span-1 m-2 justify-center items-center md:border-2 rounded-full md:py-1 md:shadow-sm text-gray-600 text-sm placeholder-gray-400">
        ...
        <div className="flex items-center space-x-2 border-2 p-1 rounded-full bg-white">
