...
function Footer() {
    return (
        <div className="grid grid-cols-1  gap-y-5 md:gap-y-10  pb-1 md:grid-cols-4 pl-16 pt-8 pr-8 md:px-32 md:pt-14 bg-gray-100 text-gray-600 ">
            <div className="space-y-4 text-xs md:text-xl text-gray-800 border-b-2 border-gray-200  pb-5 md:border-none">
            ...
            <div className="space-y-4 text-xs md:text-xl text-gray-800   pb-5 md:border-none">
